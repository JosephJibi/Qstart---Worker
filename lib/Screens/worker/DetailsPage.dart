          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const Spacer(),
                           ...
                           Text('Current Status :    ',style: GoogleFonts.poppins(fontWeight: FontWeight.w500),),
                          Container(
                              decoration: BoxDecoration(
                                  borderRadius:
                ...
                children: [
                  //Done
                  if (document['status']=='Processing' || document['status']=='Pending') GestureDetector(
                    onTap: (){
                        DonepopUpBox(context,document.id,document['status']);
                    },
                    //done
                    child: Container(
                      decoration: BoxDecoration(
                      ...
                      child: Padding(
                        ...
                        // child: Text(document['status']),
                        child: Text('Work is completed',style: GoogleFonts.poppins(color: Colors.white),),
                      ),
                    ),
                  ) ,
                  SizedBox(width: 40,),
                  //Pending
                  if (document['status']=='Processing' && document['status']!='Done' && document['status']!='Verified') GestureDetector(
                    onTap: (){
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        // child: Text(document['status']),
                        child: Text('Work is pending',style: GoogleFonts.poppins(color: Colors.white),),
                      ),
                    ),
                  ) ,
